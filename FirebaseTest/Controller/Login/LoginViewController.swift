...
//        passwordTextField.frame = CGRect(x: 30, y: emailTextField.bottom+30, width: scrollView.width - 60, height: 52)
//
//        loginButton.frame = CGRect(x: 30, y: passwordTextField.bottom+30, width: scrollView.width - 60, height: 52)
//    }
//
//    @objc private func loginButtonTapped() {
//        emailTextField.resignFirstResponder()
...
//            let user = result.user
//            print("Logged in user: \(user)")
//            strongSelf.navigationController?.pushViewController(HomePageViewController(), animated: true)
//        }
//    }
//
//    func alertUserLoginError(message: String = "Please enter all information to log in" ) {
